...
const documents = {
  privacy: {
    title: "隐私政策",
    updated: "更新于 2026 年 9 月 13 日",
    sections: [
      { heading: "影像与留言", body: "你主动添加的图片、GIF、视频及本人留言、回复会保存在私密账户中，不提供公开记录或他人留言。视频和 GIF 在点开后加载。仅通过手机相册选择器读取你选中的照片或视频，不访问聊天文件。原文件分享可能保留文件中的元数据，请确认内容后再发送。删除记录会同时删除关联的影像和留言，注销账户也会删除这些数据。" },
